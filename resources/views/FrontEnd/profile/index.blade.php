                ...
                <div class="card-header" style="background-color: white;">
                    <div class="row">
                        <div class="col-12 text-center"><br><br>
                            <h6>Profile {{ Auth::user()->nama_muzakki }}</h6>
                        </div>
...
<div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
    <div class="card p-4">
        <div class=" image d-flex flex-column justify-content-center align-items-center"> <button class="btn-profile btn-secondary"> <img src="{{asset('images/user.png')}}" height="100" width="100" /></button> <span class="name mt-3">{{ $user->nama_muzakki }}</span>
            <span class="idd">
                <table class="table">
                    <td>
                        <tr style="font-size: 12px">
