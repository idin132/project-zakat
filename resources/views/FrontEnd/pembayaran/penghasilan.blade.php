...
<div class='block'>
    ...
    <div class="container">
        <form action="{{ route('penghasilan.update', $penghasilan->id) }}" method="post"  enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="bukti_pembayaran" type="file" class="button" name="bukti_pembayaran" value="{{ $penghasilan->bukti }}" request>
                </div>
            </div>
